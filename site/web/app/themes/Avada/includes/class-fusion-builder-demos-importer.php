...
class Fusion_Builder_Demos_Importer {
	 ...
	 * @var string
	 */
	private static $remote_api_url = FUSION_UPDATES_URL . '/avada_demo/?fusion_builder_demos=1&compressed=1';
	 ...
	 * @since 7.3
	 */
	public static function import_demo_post_cards() {

		if ( defined( 'FUSION_BUILDER_PLUGIN_DIR' ) && file_exists( FUSION_BUILDER_PLUGIN_DIR . '/templates/post-cards/post-card-templates.php' ) ) {
			include FUSION_BUILDER_PLUGIN_DIR . '/templates/post-cards/post-card-templates.php';
		}
